  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="expense">
        ...
        <div class="clearfix">
          <el-table stripe :data="medicines" border style="width: 100%">
            <el-table-column prop="drugType" label="药品类型" align='center' min-width='25%'>
            </el-table-column>
            <el-table-column prop="medicineName.genericName" label="药品名称" align='center' min-width='25%'>
            </el-table-column>
            <el-table-column prop="drugDosage" label="药品剂型" align='center' min-width='25%'>
            </el-table-column>
            <el-table-column prop="drugNo" label="药品编号" align='center' min-width='25%'>
            </el-table-column>
          </el-table>

        </div>
        <div class="pagination">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[10, 20, 30, 40]" :page-size="10" layout=" prev, pager,next,sizes,total" background :total="totalElements">
          </el-pagination>
        </div>
        ...
        <div class="card-box">
          ...
          <el-row style="padding-left:calc(100/1920*100vw)">
            <el-col :offset="1" :span="8" class='hot-box'>
...
export default {
  ...
  methods: {
    ...
    getAllMedicine(params) {
      this.$axios
        .get(`api/medicine/getReimburseMedicine`, { params })
        .then(res => {
    ...
    onSubmit() {
      this.page = 0;
      this.$axios
        .get(`api/medicine/getReimburseMedicine`, {
          params: {
            cityId: this.value2,
